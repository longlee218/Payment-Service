export const MSG_SMT_WRONG = 'Đã có lỗi xảy ra, vui lòng thử lại sau.';
export const MSG_NOT_SUPPORT_PAYMENT_METHOD =
...
export const MSG_TRADE_WAS_SLOVED = 'Giao dịch đã được xử lý thành công.';
export const MSG_TRADE_DIFF_MONEY = 'Số tiền thực hiện giao dịch không đúng.';
export const MSG_INVALID_SIGNATURE = 'Chữ ký không hợp lệ.';

export const MSG_PARAM_INVALID = 'is not valid.';
export const MSG_PARAM_REQUIRED = 'không được bỏ trống.';
